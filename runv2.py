...
tk.Button(frame_left, text="Start System (WITH CAM)", command=start_action, height=2, bg="lightgreen").pack(pady=5, fill=tk.X)
tk.Button(frame_left, text="Start System (ONLY API)", command=start_action_api_online, height=2, bg="#1979a9").pack(pady=5, fill=tk.X)
